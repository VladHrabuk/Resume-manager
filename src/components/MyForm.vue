      ...
      <div class="column">
        <div class="border">
          ...
          <my-input
            ...
            :error="
              v$.resume.nameAndSurname.$error
                ? v$.resume.nameAndSurname.$errors[0].$message
                : ''
            "
          />
          <my-input
            ...
            :error="
              v$.resume.contact.$error
                ? v$.resume.contact.$errors[0].$message
                : ''
            "
          />
          <my-input
            ...
            placeholder="Email"
            :error="
              v$.resume.email.$error ? v$.resume.email.$errors[0].$message : ''
            "
          />
          <my-input
            ...
            :error="
              v$.resume.linkedin.$error
                ? v$.resume.linkedin.$errors[0].$message
                : ''
            "
          />
        </div>
        <div class="border">
          ...
          <my-textarea
            ...
            :error="
              v$.resume.aboutme.$error
                ? v$.resume.aboutme.$errors[0].$message
                : ''
            "
          />
        </div>
        <div class="border">
          ...
          <my-input-records
            ...
            :error="
              v$.resume.languages.$error
                ? v$.resume.languages.$errors[0].$message
                : ''
            "
          />
        </div>
      ...
      <div class="column">
        <div class="border">
          ...
          <my-textarea
            ...
            placeholder="Enter here"
            :error="
              v$.resume.education.$error
                ? v$.resume.education.$errors[0].$message
                : ''
            "
          />
        </div>
        <div class="border">
          ...
          <my-textarea
            ...
            placeholder="Enter here"
            :error="
              v$.resume.experience.$error
                ? v$.resume.experience.$errors[0].$message
                : ''
            "
          />
        </div>
        <div class="border">
          ...
          <my-input-records
            ...
            :clear-on-submit="formSubmitted"
            :error="
              v$.resume.skills.$error
                ? v$.resume.skills.$errors[0].$message
                : ''
            "
          />
        </div>
        <div class="border">
          ...
          <my-input-records
            ...
            :clear-on-submit="formSubmitted"
            :error="
              v$.resume.references.$error
                ? v$.resume.references.$errors[0].$message
                : ''
            "
          />
        </div>
